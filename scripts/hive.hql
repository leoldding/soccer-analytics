...
CREATE TABLE home_stats(full_time_home_goals INT, half_time_home_goal INT, home_shots INT, home_shots_target INT, home_fouls INT, home_corners INT, home_yellows INT, home_reds INT, half_time_result INT, full_time_result INT);

DROP TABLE IF EXISTS away_stats;
CREATE TABLE away_stats(full_time_away_goals INT, half_time_away_goal INT, away_shots INT, away_shots_target INT, away_fouls INT, away_corners INT, away_yellows INT, away_reds INT, half_time_result INT, full_time_result INT);
